	...
	{:else if songDetails}
		...
		<div class="player">
			...
			<div class="controls">
				<button
					class="ctrl-btn"
					on:click={() => music.skipToPreviousItem()}
				>
					<svg
						viewBox="0 0 24 24"
						fill="currentColor"
				...
				>
					...
					>
						<path
							d="M6 18l8.5-6L6 6v12zm2-8.14 4.96 3.5L8 15.86V9.86zM16 6h2v12h-2z"
						/>
					</svg>
				</button>
			</div>
